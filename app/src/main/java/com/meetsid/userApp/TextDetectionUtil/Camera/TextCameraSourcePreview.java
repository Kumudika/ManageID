 ...
 */
public class TextCameraSourcePreview extends ViewGroup {
    ...
    private TextCameraSource cameraSource;

    private TextGraphicOverlay overlay;

    public TextCameraSourcePreview(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void start(TextCameraSource cameraSource) throws IOException {
    ...
    public void start(TextCameraSource cameraSource, TextGraphicOverlay overlay) throws IOException {
