...
package com.meetsid.userApp.TextDetectionUtil.Camera;
...
public class TextCameraSource {
    ...
    private final TextGraphicOverlay graphicOverlay;
    ...
    private ImageRecognitionProcessor imageRecognitionProcessor;
    ...
    public TextCameraSource(Activity activity, TextGraphicOverlay overlay) {
    ...
    public synchronized TextCameraSource start() throws IOException {
        if (camera != null) {
            return this;
        }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public synchronized TextCameraSource start(SurfaceHolder surfaceHolder) throws IOException {
        if (camera != null) {
            return this;
        }
    ...
    public void setMachineLearningImageProcessor(ImageRecognitionProcessor processor) {
        synchronized (processorLock) {
            cleanScreen();
            if (frameProcessor != null) {
                frameProcessor.stop();
            }
            imageRecognitionProcessor = processor;
        }
    }
                ...
                try {
                    synchronized (processorLock) {
                        ...
                        if (frameProcessor != null) {
                            ...
                            imageRecognitionProcessor.process(
                                    data,
                                    new TextFrameMetadata.Builder()
                                            .setWidth(previewSize.getWidth())
                                            .setHeight(previewSize.getHeight())
