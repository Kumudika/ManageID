...
public class DropDownBox extends AppCompatEditText implements View.OnClickListener {
    ...
    public DropDownBox(Context context, AttributeSet attrs, int defStyleAttr) {
